...
const Insta = () => {
  ...
  return (
    <div className='w-full lg:px-20 px-5 py-[80px] bg-white flex flex-col justify-center items-center gap-4'>
      <h1 data-aos="zoom-in" data-aos-delay="100" className='text-purple-600 text-xl font-semibold capitalize'> Our Instragram shop</h1>
      ...
      <button data-aos="zoom-in" data-aos-delay="400" className='bg-purple-600 hover:bg-yellow-300 text-white hover:text-black font-semibold px-8 py-3 rounded-lg mt-12 uppercase'>Shop</button>

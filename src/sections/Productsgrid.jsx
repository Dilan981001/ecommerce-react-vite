...
const Productsgrid = () => {
  ...
  return (
    <div id='products' className='w-full lg:px-20 px-5 py-[80px] bg-gray-100 flex flex-col justify-center items-center gap-4'>
          ...
          products.map((item, index)=>(
            <div id='product-box' key={index} className='flex flex-col justify-center items-center gap-2 bg-white p-4 rounded-lg cursor-pointer relative'>
              ...
              <div id='icons' className='flex justify-center items-center gap-3 absolute top-[20px]'>
                <div className='bg-purple-600 hover:bg-yellow-300 hover:text-black rounded-full p-3 text-white'>
               ...
               <h1 className='text-lg text-purple-600 font-semibold'>{item.price}</h1>
      ...
      <button data-aos="zoom-in" data-aos-delay="400" className='bg-purple-600 hover:bg-yellow-300 text-white hover:text-black font-semibold px-8 py-3 rounded-lg mt-8'>VIEW MORE</button>
